"""Config flow for Lighting Manager integration."""
            ...
            if not errors:
                ...
                return self.async_create_entry(
                    ...
                    data={
                        ...
                        "area_id": None,  # Optional area association (future)
                    },
                    options={
...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(
        ...
        """Manage the options."""
        if user_input is not None:
            # CRITICAL FIX: Properly reconstruct ranges as arrays
            options_data = {
        ...
        brightness_range = options.get("adaptive_brightness_range", [DEFAULT_BRIGHTNESS_MIN, DEFAULT_BRIGHTNESS_MAX])
        color_temp_range = options.get("adaptive_color_temp_range", [DEFAULT_COLOR_TEMP_MIN, DEFAULT_COLOR_TEMP_MAX])
