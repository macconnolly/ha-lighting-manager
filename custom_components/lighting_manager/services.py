...
async def _get_switch_entities(hass: HomeAssistant, call: ServiceCall) -> list:
    ...
    for entity_id in entity_ids:
        ...
        if entity and hasattr(entity, "coordinator") and hasattr(entity, "layer_id"):
...
async def handle_deactivate_layer(call: ServiceCall) -> ServiceResponse:
...
async def handle_update_layer(call: ServiceCall) -> ServiceResponse:
...
async def handle_set_layer_priority(call: ServiceCall) -> ServiceResponse:
...
async def handle_lock_layer(call: ServiceCall) -> ServiceResponse:
    ...
    from .services_phase3 import handle_lock_layer as _handle_lock
    ...
    return await _handle_lock(hass, call, switches)


async def handle_unlock_layer(call: ServiceCall) -> ServiceResponse:
    """Unlock layers to allow modifications."""
    from .services_phase3 import handle_unlock_layer as _handle_unlock
    ...
    return await _handle_unlock(hass, call, switches)


async def handle_force_layer(call: ServiceCall) -> ServiceResponse:
    """Force layers to override priority system."""
    from .services_phase3 import handle_force_layer as _handle_force
    ...
    return await _handle_force(hass, call, switches)


async def handle_unforce_layer(call: ServiceCall) -> ServiceResponse:
    """Remove force flag from layers."""
    call.data["force"] = False
    return await handle_force_layer(call)


async def handle_recalculate_zone(call: ServiceCall) -> ServiceResponse:
    """Force immediate recalculation for a zone."""
    from .services_phase3 import handle_recalculate_zone as _handle_recalc
    ...
    return await _handle_recalc(hass, zone_id, coordinator)


async def handle_reset_zone(call: ServiceCall) -> ServiceResponse:
    """Reset zone by deactivating all layers except base."""
    from .services_phase3 import handle_reset_zone as _handle_reset
    ...
    return await _handle_reset(hass, zone_id, coordinator)


async def handle_apply_preset(call: ServiceCall) -> ServiceResponse:
    """Apply a preset configuration atomically."""
    from .services_phase3 import handle_apply_preset as _handle_preset
    ...
    return await _handle_preset(hass, zone_id, preset_name, coordinator, transition)